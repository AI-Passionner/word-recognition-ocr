...
class TextUtils(object):
    ...
    def get_best_candidate(word, ngram_dict, threshold=0.8):
        ...
        :param word: alphabet string
        :param ngram_dict: a dictionary of {word: frequency}, where the frequency is just a ranking parameter
                           from a text corporas
    ...
    def bigrams_spellcheck(word_dict):
        ...
        for bi in next(TextUtils.create_ngrams(all_word_ids, 2)):
